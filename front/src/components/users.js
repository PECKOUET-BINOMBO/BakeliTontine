...
import bwhite from "../assets/images/b-white.svg";
      ...
      <div className="parent-add col-9 heigtht-box">
        ...
        <div className="container mt-3">
          ...
          <div className="boxbtn">
            <button className="btn btnAjout" onClick={() => setIsOpen(true)}>
              Ajouter
            </button>
          </div>
            ...
            <table className="table tableSuivi">
              ...
              <tr className="tbody">
                ...
                <td className="tdActions">
                  <span>
                    <img src={eye} alt="eye" onClick={() => setIsOpen2(true)} />
                  </span>
                  <span className="mx-2">
        ...
        {isOpen && <ModalRegister setIsOpen={setIsOpen} />}
